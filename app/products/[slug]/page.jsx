...
<select onChange={(e) => setquantity(e.target.value)} id="quantity" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-16 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  ...
  <option value="5">5</option>
          ...
          <div className='btns space-x-5'>
            <button className='bg-blue-500 text-white px-5 py-2 disabled:cursor-not-allowed mb-10' disabled>Add To Cart</button>
            <button className='bg-green-500 text-white px-5 py-2' onClick={buyingHandler}>Buy Now</button>
          </div>
        </div>
      </div>
    </div>
